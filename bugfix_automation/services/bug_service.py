...
from bugfix_automation.domain.capability_system import render_capability_contract
...
from bugfix_automation.orchestration.bug_runner import list_bugs, run_one
from bugfix_automation.domain.task_state import is_task_active, set_task_state, task_state
from bugfix_automation.domain.ai_cli import ai_cli_label, ai_cli_print_command
